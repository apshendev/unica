...
> Выполнено: 2026-08-25 17:12 (6 — четыре файла docs/plans/2026-08-25-opencode-*.md
> tracked: два перенесённых плана (git add фиксирует состоявшийся перенос),
> ревью, настоящий план; на двух старых tracked-путях docs/code-review/… —
> короткие pointer'ы («перенесён; формулировки не менялись»); в перенесённый
> steps-файл добавлена датированная отметка superseded у шага 4 с run
> 32766639619; новый docs/plans/2026-08-25-opencode-local-tgz-from-tag-run.md
> фиксирует процедуру run 31950933025 (event push, branch v0.12.0, head SHA
> 6f2acb27… == targetCommitish) с обязательным префлайтом трёх manifest SHA и
> закреплённым красным сигналом 3/3 mismatch старого артефакта; раздел 2.2
> настоящего плана уже ведёт на новый путь; git grep
> "docs/code-review/2026-08-25" показывает только историческую запись ревью и
> проза самого этапа 6; git status по этим путям чист; test_design_documents
> Ran 14 OK)
